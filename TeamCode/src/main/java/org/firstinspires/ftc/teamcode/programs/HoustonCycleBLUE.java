...
@Autonomous(name = "HoustonCycleBLUE")
public class HoustonCycleBLUE extends LinearOpMode {
    DcMotor lift1;
    Vision vision;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(6, 62, Math.toRadians(180));
        ...
        TrajectorySequence preloadHigh = robot.drive.drive.trajectorySequenceBuilder(startPose)
                .addDisplacementMarker(() -> {
                    deposit();
                }).lineToConstantHeading(new Vector2d(-7, 62.5))
                .waitSeconds(0.1)
                .addTemporalMarker(() -> {
                    kick();
                })
                .addTemporalMarker(() -> {
                    robot.intake.autoBLUE();
                    robot.intake.intakeDown();
                })
                .lineToConstantHeading(new Vector2d(45, 62.5),   robot.drive.drive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                ...
                .lineToConstantHeading(new Vector2d(-7, 63))
                .addTemporalMarker(() -> {
                    robot.intake.off();
                    kick();
                })
